...
import com.krma.karmaapp.util.HibernateUtil;
    ...
    public Response updatePost(@PathParam("id") Integer id, Post post) {
        ...
        try {
            ...
            if (postDB != null) {
                ...
                postDB.setPostulantes(post.getPostulantes());
                postDB.setComentarios(post.getComentarios());
                postDB.setFecha(post.getFecha());
